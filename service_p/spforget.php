...
<body>
    ...
    <div class="container" id="container">
        <form action="spforget.php" method="post">
...
{
	$email1 =$_POST['email1'];
	$query="Select * from service_provider where sp_email='$email1'";
	...
	$conf = $_POST['confirm'];
        ...
        if($newpass==$conf){
        $sql="UPDATE service_provider SET sp_pass='$conf' where sp_email='$email'";
