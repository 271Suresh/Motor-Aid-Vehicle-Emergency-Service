...
<body >
	...
	<div id="body">
		<h1><span>Available Service Provider</span></h1>
		<div>
			<ul>
				<li>
					
				<table border ="1" id="sp">
						<tr>
						<th>ID</th>
						<th>Name</th>
						<!-- <th>Lastname</th> -->
						...
						$sql = "SELECT sp_id,sp_name, sp_phno, sp_img FROM service_provider where service_type='towing'";
						...
						if($result->num_rows > 0){
							while($row = $result->fetch_assoc()){
								...
								"</td><td><a href='tow.php?sp=$row[sp_id]'>Send</td></tr>";
